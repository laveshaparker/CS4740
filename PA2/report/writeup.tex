...
\item For the purpose of later calculations, we tokenize the document into sentences (\textit{sentences \text{and} sentences\_w\_case}), and then those sentences into an array of tokens, with punctuation removed
\end{enumerate}
...
% TODO If I get to this
% This step can be separated into both a general ranking scheme and a fine-tuning scheme. To examine both separately we have:\\
